...
class MycommentsCommentRenderer
{
     ...
     *
     * @return MycommentsCommentRenderer
     */
     ...
     * @return MycommentsCommentRenderer
     */
    public static function getInstance($tpl, $use_icons = true, $do_iconcheck = false)
    {
        static $instance;
        if (null === $instance) {
     ...
     * @param string  $modlink
     * @param string  $itemlink
     */
    public function renderFlatView($admin_view = false, $modlink = '', $itemlink = '')
    {
